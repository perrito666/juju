...
type storageAccess interface {
	// AttachFilesystem is required for storage functionality.
	AttachFilesystem(names.MachineTag, names.FilesystemTag) error

	// DetachFilesystem is required for storage functionality.
